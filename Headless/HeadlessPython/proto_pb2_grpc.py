...
class GymServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Step = channel.unary_unary(
                '/GymService/Step',
                request_serializer=proto__pb2.Action.SerializeToString,
...
def add_GymServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Step': grpc.unary_unary_rpc_method_handler(
                    servicer.Step,
                    request_deserializer=proto__pb2.Action.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'GymService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('GymService', rpc_method_handlers)
...
class GymService:
    ...
    def Step(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/GymService/Step',
            proto__pb2.Action.SerializeToString,
